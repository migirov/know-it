...
const App = () =>{
  ...
  const DATA = [
    {
      "opening-txt": "אנו מתרגשים להזמינכם לכנס ה-4 בנושא חדשנות בלמידה, כנס מיוחד וחוויתי שמחבר מגזרים שונים למכנה משותף - חדשנות בלמידה.",
      "for-whom-txt": "כ-1000 מפתחי ומנהלי הדרכה מיחידות צה״ל, מגופי ביטחון נוספים, מהאקדמיה, מהתעשייה, ומהרשויות המקומיות. ",
      "where-txt": "קריית ההדרכה - מחנה אריאל שרון.",
      "when-txt": "הכנס יתקיים ביום שלישי ה-22 בנובמבר 2022 בין השעות 8:30-15:00.",
      "plans": "2 הרצאות מליאה, מושבים, סדנאות, תערוכת ספקים, אוכל טוב, ומינגלינג. פרטים נוספים בהמשך... ",
    }
  ]
  return (
    <div className="App">

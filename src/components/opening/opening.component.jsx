...
const Opening = (props) => {
    ...
    return (
        <div className="opening">
            ...
            <div className="opening-txt">כנס חדשני ויחיד מסוגו בנושא חדשנות בלמידה. הכנס מיועד למפקדים בקריית ההדרכה, מטה הדרכה באגפים ובחילות, אורחים מצה״ל, האקמיה והתעשייה.</div>

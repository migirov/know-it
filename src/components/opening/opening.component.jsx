...
const Opening = (props) => {
    ...
    return (
        <div className="opening">
            ...
            <div className="opening-txt">כנס חדשני ויחיד מסוגו בנושא חדשנות בלמידה. הכנס מיועד למנהלי הדרכה בכירים - מפקדים בהכשרות (רס״ן ומעלה) ולאנשי פיתוח הדרכה בצה״ל ומחוצה לו.</div>
